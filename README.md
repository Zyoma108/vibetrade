...
Асинхронный торговый бот для криптобирж. Детектит пампинг-сетапы по аномальному объёму и росту открытого интереса, управляет позициями, отправляет сигналы в Telegram.
